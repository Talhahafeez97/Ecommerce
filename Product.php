<?php 
  ...
  if(!isset($_SESSION["Userr"])) {
    header("location:Home.php?False=true");
  }
 ?>
    ...
    <div class="container">
        <div class="row justify-content-center">
          ...
          ?>
              ...
              <form action="AddProduct.php" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-8">
                    <input class="form-control" name="pPrice" value="" type="text" required>
                  <br>
                  </div>
